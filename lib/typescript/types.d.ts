...
type type_os = "all" | "disk" | "main" | "proc" | "serv" | "sock";
...
// * dashboard-payload           - transmit_dashboard        - Contains all initial data for populating the dashboard browser page
