...
type type_socket_data = server_os | services_action_compose | services_action_server | services_clock | services_dashboard_status | services_dashboard_terminal | services_dns_input | services_dns_output | services_dns_reverse | services_docker_compose | services_fileSystem | services_hash | services_http_test | services_os_disk | services_os_intr | services_processKill | services_terminal_resize | services_testBrowser | services_websocket_handshake | services_websocket_message | services_websocket_status | store_string | string[] | transmit_dashboard | type_list_services;
