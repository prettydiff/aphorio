...
type type_service = "dashboard-compose-container" | "dashboard-compose-variables" | "dashboard-dns" | "dashboard-fileSystem" | "dashboard-hash" | "dashboard-http" | "dashboard-os" | "dashboard-payload" | "dashboard-server" | "dashboard-status" | "dashboard-websocket-handshake" | "dashboard-websocket-message" | "dashboard-websocket-response" | "dashboard-websocket-status" | "youtube-download-status";
