...
const dashboard:dashboard = {
    execute: function dashboard_execute(core:(config:config_core) => socket_object):void {
        ...
        dashboard.socket = core({
            ...
            open: function dashboard_execute_socketOpen(event:Event):void {
                ...
                if (dashboard.global.loaded === false) {
                    ...
                    if (dashboard.sections["disks"] !== undefined) {
                        dashboard.sections["disks"].init();
                    }
                    if (dashboard.sections["dns-query"] !== undefined) {
                        dashboard.sections["dns-query"].init();
                    }
                    if (dashboard.sections["file-system"] !== undefined) {
                        dashboard.sections["file-system"].init();
                    }
                    if (dashboard.sections["hash"] !== undefined) {
                        dashboard.sections["hash"].init();
                    }
                    if (dashboard.sections["http-test"] !== undefined) {
                        dashboard.sections["http-test"].init();
                    }
                    if (dashboard.sections["interfaces"] !== undefined) {
                        dashboard.sections["interfaces"].init();
                    }
                    if (dashboard.sections["os-machine"] !== undefined) {
                        dashboard.sections["os-machine"].init();
                    }
                    ...
                    if (dashboard.sections["sockets-application"] !== undefined) {
    ...
    global: {
        ...
        state: (function dashboard_state():state_store {
            const local:string = (typeof localStorage === "undefined")
                    ? undefined
                    : localStorage.state,
                item = (local === undefined || local === null || local === "")
                    ? {
                        dns: {
                            hosts: "",
                            types: ""
    ...
    sections: {
        ...
        "file-system": {
            ...
            time: 0n,
            tools: {
                media_time: function dashboard_sections_fileSystem_mediaTime(input:boolean|string|number):string {
        ...
        "http-test": {
            ...
            nodes: {
                ...
                stats: document.getElementById("http").getElementsByClassName("summary-stats")[0] as HTMLElement,
        ...
        "processes": {
            ...
            receive: null,
            row: function dashboard_sections_porcesses_row(record_item:type_lists, tr:HTMLElement):void {
    ...
    tables: {
        ...
        init: function dashboard_tables_init(module:module_list|section_ports_application|section_sockets_application):void {
            ...
            if (module.dataName === "ports_application") {
                ...
                tables.populate(module, dashboard.global.payload.os[module.dataName as type_list_services]);
            }
        },
